...
export default class Loader {
    ...
    public async loadAssets() {
        ...
        Assets.add({alias:"activeButton", src:"./assets/metamask_enable.png"});
        Assets.add({alias:"disableButton", src:"./assets/metamask_disable.png"});
        await Assets.load(["atlas","activeButton","disableButton"]);
